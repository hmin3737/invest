...
export async function GET() {
  ...
  const guide = [
    ...
    ["4. 유형: 매수 / 매도 / 입금 / 출금 / 배당  중 하나 (영문 BUY 등도 가능)"],
    ["5. 총금액: 필수 입력 (양수)"],
    ["6. 티커: 매수·매도·배당의 경우 필수  (예: AAPL, 005930.KS, BTC-USD)"],
  ...
  // ── 거래내역 시트 ─────────────────────────────────────────
  const headers = ["날짜", "유형", "티커", "종목명", "수량", "단가", "총금액", "메모"];
  const examples = [
    ["2024-01-02", "입금", "", "", "", "", 10000000, "초기 투자금"],
    ["2024-01-05", "매수", "AAPL", "Apple Inc.", 10, 185.5, 1855000, "환율 반영 금액"],
    ["2024-02-01", "매수", "005930.KS", "삼성전자", 50, 72000, 3600000, ""],
    ["2024-06-15", "배당", "AAPL", "Apple Inc.", "", "", 28000, "2024 Q2 배당"],
    ["2024-09-01", "매도", "AAPL", "Apple Inc.", 5, 225.0, 1575000, "일부 매도"],
    ["2024-10-01", "출금", "", "", "", "", 500000, "일부 인출"],
  ];
